                ...
                <div className="row">
                    <div className="col-4">
                        ...
                        <p>
                            ...
                            Điều đó giúp bạn có những trải nghiệm tốt hơn trên
                            hành trình của mình.
                        </p>
                    </div>
                    <div className="col-4">
                        ...
                        <p>
                            Thời gian chờ, số ghế trống, giá cả, chất lượng tài
                            xế, các đánh giá, … tất cả sẽ được hiển thị rõ ràng
                            để bạn yên tâm đặt chuyến đi.
                        </p>
                    </div>
                    <div className="col-4">
                        ...
                        <p>
                            ...
                            trồng 4 cây xanh cho việc hấp thụ khí C02 trong vòng
                            1 năm.
                        </p>
                    </div>
                </div>
